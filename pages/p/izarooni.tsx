    ...
    return (
        <Project props={{
            ...
            <div className="section">
                <h1 className="title has-text-centered">Design Concepts</h1>
            ...
            <div className="section">
                ...
                <div className="columns is-vcentered">
                    ...
                    <div className="column content">
                        ...
                        The core of the website was built using a PHP framework, <span className='has-text-weight-bold'>CodeIgniter</span>. It's lightweight, easy to use and most importantly, in a programming language I'm familiar with (PHP).
                    </div>
                </div>
            </div>
            ...
            <div className="section">
                ...
                <div className="columns is-vcentered">
                    ...
                    <div className="column content">
                        After leaving the website alone for several months I suddenly had an idea for a new design.
                        Given that this website isn't large or complicated, I also decided to use a new framework, <a href="https://remix.run/" target="_blank" className="has-text-link">Remix</a>.
                        <br />
                        <br />
